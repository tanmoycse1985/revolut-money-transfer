...
public class UserDAOImpl implements UserDAO {
    ...
    public List<User> getAllUsers() throws RevolutException {
        ...
        try {
            ...
            throw new RevolutException("Error reading user data", e);
        } finally {
     ...
     * Find user by userId
     */
    public User getUserById(long userId) throws RevolutException {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        User u = null;
     ...
     */
    public User getUserByName(String userName) throws RevolutException {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        User u = null;
     ...
     * Save User
     */
    public long insertUser(User user) throws RevolutException {
        Connection conn = null;
        PreparedStatement stmt = null;
        ...
        try {
            ...
            if (affectedRows == 0) {
                ...
                throw new RevolutException("Users Cannot be created");
            }
            ...
            throw new RevolutException("Error creating user data", e);
        } finally {
     ...
     * Update User
     */
    public int updateUser(Long userId,User user) throws RevolutException {
        Connection conn = null;
        PreparedStatement stmt = null;
        ...
        try {
            ...
            throw new RevolutException("Error update user data", e);
        } finally {
     ...
     * Delete User
     */
    public int deleteUser(long userId) throws RevolutException {
        Connection conn = null;
        PreparedStatement stmt = null;
        ...
        try {
            ...
            throw new RevolutException("Error Deleting User ID:"+ userId, e);
        } finally {
            DbUtils.closeQuietly(conn);
            DbUtils.closeQuietly(stmt);
        }
